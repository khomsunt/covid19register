            ...
            <tr id="<?php echo $value['covid_register_id'] ?>">
              ...
              <td>
                ...
                <div class="data select_date_arrived_sakonnakhon_<?php echo $value['covid_register_id']; ?>" style="display:none">
                  <input name="date_arrived_sakonnakhon" class="form-control datepicker_skn" id="date_arrived_sakonnakhon_<?php echo $value['covid_register_id']; ?>" value="<?php echo deFormatDate($value['date_arrived_sakonnakhon']); ?>"/>
<script>
  $("#date_arrived_sakonnakhon_<?php echo $value['covid_register_id']; ?>").datepickerSkn('<?php echo date('Y-m-d'); ?>');
</script>
                </div>
              </td>
              <td>
